    ...
    <header className="bg-blue-600 text-white p-4 fixed w-full top-0 left-0 z-10">
      ...
      <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
        <nav className="flex flex-col items-end bg-blue-600 py-4">
          <a href="#summary" onClick={closeMenu} className="hover:underline underline-offset-8 px-4 py-2">Summary</a>
          <a href="#skills" onClick={closeMenu} className="hover:underline underline-offset-8 px-4 py-2">Skills</a>
          <a href="#working" onClick={closeMenu} className="hover:underline underline-offset-8 px-4 py-2">Working</a>
          <a href="#education" onClick={closeMenu} className="hover:underline underline-offset-8 px-4 py-2">Education</a>
          <a href="#contact" onClick={closeMenu} className="hover:underline underline-offset-8 px-4 py-2">Contact</a>
        </nav>
      </div>
    </header>
  );
